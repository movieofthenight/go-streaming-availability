...
func (r ApiCountriesRequest) Execute() (*CountriesResponseSchema, *http.Response, error) {
	return r.ApiService.CountriesExecute(r)
}
...
func (a *DefaultAPIService) CountriesExecute(r ApiCountriesRequest) (*CountriesResponseSchema, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CountriesResponseSchema
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.Countries")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
